...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .country:hover { fill: var(--paper-dark) !important; }
...
<main>
  <div class="map-wrap">
    ...
    <div class="map-mode-toggle">
      <button id="btn-2d-eur" class="toggle-btn active">2D Europa</button>
      <button id="btn-2d-glob" class="toggle-btn">2D Planiglob</button>
...
const globalMajorData = {
  'united states of america': {
    ...
    flag: '\uD83C\uDDFA\uD83C\uDDF8',
    categorie: 'norec',
    categorieLabel: 'Nu recunoa\u0219te Palestina',
    lat: 37.0902,
    lon: -95.7129,
    coords: [-95.7129, 37.0902],
    capitala: 'Washington, D.C.',
    populatie: '\u2248 335 000 000 loc.',
    popVal: 335000000,
    suprafata: '9 833 517 km\u00B2',
    supVal: 9833517,
    zee: '\u2014',
    moneda: 'Dolar american (USD)',
    particularitati: 'Cel mai important aliat strategic al Israelului din emisfera vestic\u0103.',
    note: 'Statele Unite ale Americii nu recunosc oficial Statul Palestina ca stat suveran, sus\u021Bin\u00E2nd c\u0103 statalitatea palestinian\u0103 trebuie s\u0103 fie rezultatul unor negocieri directe \u00EEntre Israel \u0219i Autoritatea Palestinian\u0103.',
    viza: {
      particular: 'Controleaz\u0103 direct asisten\u021Ba financiar\u0103 \u0219i are drept de veto \u00EEn Consiliul de Securitate al ONU.',
      temei: 'Legisla\u021Bia federal\u0103 american\u0219 \u0219i acordurile strategice cu Israelul.',
      regim: 'Delega\u021Bie general\u0103 a OEP activ\u0103 la Washington la nivel redus.',
      observatie: 'Sprijin militar \u0219i diplomatic necondi\u021Bionat pentru Israel.'
    },
    ue: 'Stat partener strategic non-european.',
    schengen: 'Regim de scutire de vize (ESTA) pentru statele din spa\u021Biul Schengen.'
  },
  'united states': { inherits: 'united states of america' },
  'china': {
    id: 'chn',
    nume: 'Republica Popular\u0103 Chinez\u0103',
    numeEn: 'China',
    flag: '\uD83C\uDDE8\uD83C\uDDF3',
    categorie: 'rec',
    ...
    capitala: 'Beijing',
    populatie: '\u2248 1 411 000 000 loc.',
    popVal: 1411000000,
    suprafata: '9 596 961 km\u00B2',
    supVal: 9596961,
    zee: '1988',
    moneda: 'Renminbi / Yuan (CNY)',
    particularitati: 'Sprijin istoric consecvent pentru cauza palestinian\u0103 \u00EEn forurile ONU.',
    note: 'China a recunoscut oficial Statul Palestina \u00EEn noiembrie 1988, imediat dup\u00E3 Declara\u021Bia de Independen\u021B\u0103, \u0219i men\u021Bine rela\u021Bii diplomatice depline, promov\u00E2nd solu\u021Bia celor dou\u0103 state \u0219i o participare mai larg\u0103 la conferin\u021Bele de pace.',
    viza: {
      particular: 'Ambasada Palestinei func\u021Bioneaz\u0103 activ la Beijing, primind statut diplomatic complet.',
      temei: 'Rela\u021Bii istorice consolidate de la era Mao Zedong \u0219i sprijin geopolitic regional.',
      regim: 'Vizite diplomatice frecvente \u0219i acorduri economice bilaterale.',
      observatie: 'China sprijin\u0103 calitatea de membru deplin al Palestinei la ONU.'
    },
    ue: 'Partener comercial major \u0219i concurent strategic global.',
    schengen: 'Regim de vize obligatoriu standard.'
  },
  'brazil': {
    id: 'bra',
    nume: 'Brazilia',
    ...
    capitala: 'Bras\u00EDlia',
    populatie: '\u2248 215 000 000 loc.',
    popVal: 215000000,
    suprafata: '8 515 767 km\u00B2',
    supVal: 8515767,
    zee: '2010',
    moneda: 'Real brazilian (BRL)',
    particularitati: 'Lider regional \u00EEn promovarea recunoa\u0219terii Palestinei \u00EEn America Latin\u0103.',
    note: 'Brazilia a recunoscut oficial Statul Palestina \u00EEn decembrie 2010, \u00EEn grani\u021Bele din 1967, declan\u0219\u00E2nd un val de recunoa\u0219teri similare \u00EEn \u00EEntreaga Americ\u0103 de Sud.',
    viza: {
      particular: 'Ambasada Palestinei func\u021Bioneaz\u0103 activ la Bras\u00EDlia.',
      temei: 'Schimbare strategic\u0103 de politic\u0103 extern\u0103 orientat\u0103 spre Sudul Global.',
      regim: 'Reprezentare diplomatic\u0103 deplin\u0103 stabilit\u0103 din 2010.',
      observatie: 'Sprijin\u0103 activ rezolu\u021Biile ONU pentru suveranitatea palestinian\u0103.'
    },
    ue: 'Stat partener non-european comercial major.',
    schengen: 'Acord de scutire de vize pentru \u0219ederi de scurt\u0103 durat\u0103 cu statele UE.'
  },
  'canada': {
    id: 'can',
    nume: 'Canada',
    ...
    capitala: 'Ottawa',
    populatie: '\u2248 39 000 000 loc.',
    popVal: 39000000,
    suprafata: '9 984 670 km\u00B2',
    supVal: 9984670,
    zee: '2025',
    moneda: 'Dolar canadian (CAD)',
    particularitati: 'Recunoa\u0219tere istoric\u0103 extins\u0103 \u00EEn toamna anului 2025 al\u0103turi de Marea Britanie \u0219i Australia.',
    note: '\u00EEntr-o turnur\u0103 diplomatic\u0103 istoric\u0103 \u00EEn septembrie 2025, Canada, al\u0103turi de Regatul Unit \u0219i Australia, a extins recunoa\u0219terea oficial\u0103 a Statului Palestina ca parte a unui efort interna\u021Bional coordonat pentru deblocarea procesului de pace \u0219i sprijinirea solu\u021Biei celor dou\u0103 state.',
    viza: {
      particular: 'Reprezentare diplomatic\u0103 deplin\u0103 stabilit\u0103 recent.',
      temei: 'Decizie comun\u0103 guvernamental\u0103 de aliniere interna\u021Bional\u0103.',
      regim: 'Misiune diplomatic\u0103 palestinian\u0103 deplin\u0103 la Ottawa.',
      observatie: 'Trecere de la o politic\u0103 istoric\u0103 de ab\u021Binere la un rol proactiv.'
    },
    ue: 'Partener strategic transatlantic de top.',
    schengen: 'Regim de c\u0103l\u0103torie f\u0103r\u0103 vize (eTA).'
  },
  'australia': {
    id: 'aus',
    nume: 'Australia',
    ...
    capitala: 'Canberra',
    populatie: '\u2248 26 000 000 loc.',
    popVal: 26000000,
    suprafata: '7 692 024 km\u00B2',
    supVal: 7692024,
    zee: '2025',
    moneda: 'Dolar australian (AUD)',
    particularitati: 'Recunoa\u0219tere coordonat\u0103 \u00EEn septembrie 2025 \u00EEn sprijinul solu\u021Biei a dou\u0103 state.',
    note: 'Australia a recunoscut oficial Statul Palestina \u00EEn toamna anului 2025 \u00EEn mod coordonat cu alia\u021Bii s\u0103i din G7, semnal\u00E2nd o schimbare strategic\u0103 major\u0103 \u00EEn politica sa extern\u0103 pentru a stimula negocierile de pace din Orientul Mijlociu.',
    viza: {
      particular: 'Reprezentare diplomatic\u0103 deschis\u0103 la Canberra.',
      temei: 'Schimbare strategic\u0103 guvernamental\u0103 pentru stabilitatea regional\u0103.',
      regim: 'Rela\u021Bii diplomatice bilaterale complete.',
      observatie: 'Consider\u0103 c\u0103 recunoa\u0219terea statalit\u0103\u021Bii ofer\u0103 echilibru procesului diplomatic.'
    },
    ue: 'Partener strategic global non-european.',
    schengen: 'Regim de vize obligatoriu standard.'
  },
  'japan': {
    id: 'jpn',
    ...
    capitala: 'Tokyo',
    populatie: '\u2248 125 000 000 loc.',
    popVal: 125000000,
    suprafata: '377 975 km\u00B2',
    supVal: 377975,
    zee: '\u2014',
    moneda: 'Yen japonez (JPY)',
    particularitati: 'Unul dintre cei mai importan\u021Bi donatori de asisten\u021B\u0103 pentru dezvoltare din Palestina.',
    note: 'Japonia nu recunoa\u0219te oficial Statul Palestina ca stat suveran, dar men\u021Bine un birou de reprezentare la Ramallah \u0219i este unul dintre cei mai mari donatori de asisten\u021B\u0103 umanitar\u0103 \u0219i economic\u0103 pentru poporul palestinian, sus\u021Bin\u00E2nd activ dreptul la autodeterminare.',
    viza: {
      particular: 'Men\u021Bine un birou de reprezentare la Ramallah \u0219i colaboreaz\u0103 str\u00E2ns pe teme de dezvoltare.',
      temei: 'Sus\u021Binere ferm\u0103 a solu\u021Biei a dou\u0103 state \u0219i a dreptului la autodeterminare.',
      regim: 'Rela\u021Bii guvernamentale prin Reprezentan\u021Ba din Tokyo \u0219i Ramallah.',
      observatie: 'Implementeaz\u0103 ini\u021Biativa strategic\u0103 \u201ECoridorul pentru Pace \u0219i Prosperitate\u201D.'
    },
    ue: 'Partener comercial \u0219i industrial major non-european.',
    schengen: 'Regim de c\u0103l\u0103torie f\u0103r\u0103 vize \u00EEn spa\u021Biul Schengen.'
  },
  'saudi arabia': {
    id: 'sau',
    nume: 'Arabia Saudit\u0103',
    ...
    capitala: 'Riad',
    populatie: '\u2248 36 000 000 loc.',
    popVal: 36000000,
    suprafata: '2 149 690 km\u00B2',
    supVal: 2149690,
    zee: '1988',
    moneda: 'Riyal saudit (SAR)',
    particularitati: 'Lider al lumii arabe \u0219i promotor principal al Ini\u021Biativei Arabe de Pace.',
    note: 'Arabia Saudit\u0103 a recunoscut Palestina \u00EEn 1988 \u0219i este principalul promotor al Ini\u021Biativei Arabe de Pace din 2002, care propune normalizarea deplin\u0103 a rela\u021Biilor cu Israelul \u00EEn schimbul retragerii acestuia din teritoriile ocupate \u00EEn 1967 \u0219i cre\u0103rii unui stat palestinian.',
    viza: {
      particular: 'Men\u021Bine o ambasad\u0103 palestinian\u0103 deplin\u0103 la Riad \u0219i sprijin\u0103 puternic bugetul Autorit\u0103\u021Bii.',
      temei: 'Solidaritate islamic\u0103 \u0219i arab\u0103 strategic\u0103.',
      regim: 'Reprezentare diplomatic\u0103 deplin\u0103.',
      observatie: 'Condi\u021Bioneaz\u0103 normalizarea istoric\u0103 a rela\u021Biilor cu Israelul de crearea statului palestinian.'
    },
    ue: 'Partener energetic \u0219i geopolitic important.',
    schengen: 'Regim de vize obligatoriu standard.'
  },
  'egypt': {
    id: 'egy',
    ...
    capitala: 'Cairo',
    populatie: '\u2248 109 000 000 loc.',
    popVal: 109000000,
    suprafata: '1 010 408 km\u00B2',
    supVal: 1010408,
    zee: '1988',
    moneda: 'Lir\u0103 Egiptean\u0103 (EGP)',
    particularitati: 'Proximitate strategic\u0103 \u0219i control istoric asupra punctului de trecere de la Rafah.',
    note: 'Egiptul a recunoscut Palestina \u00EEn 1988 \u0219i joac\u0103 un rol istoric crucial ca mediator principal \u00EEn negocierile dintre frac\u021Biunile palestiniene \u0219i Israel, control\u00E2nd totodat\u0103 singurul punct de trecere a frontierei non-israelian \u00EEn F\u00E2\u0219ia Gaza la Rafah.',
    viza: {
      particular: 'Reprezentare diplomatic\u0103 deplin\u0103 \u0219i leg\u0103turi de securitate ultra-str\u00E2nse.',
      temei: 'Securitate na\u021Bional\u0103, proximitate geografic\u0103 \u0219i solidaritate arab\u0103.',
      regim: 'Ambasad\u0103 deplin\u0103 la Cairo \u0219i misiune diplomatic\u0103 activ\u0103.',
      observatie: 'Eforturi intense pentru unitatea politic\u0103 palestinian\u0103 (Reconcilierea Fatah-Hamas).'
    },
    ue: 'Partener de vecin\u0103tate strategic major.',
    schengen: 'Regim de vize obligatoriu standard.'
  },
  'turkey': {
    id: 'tur',
    ...
    capitala: 'Ankara',
    populatie: '\u2248 85 000 000 loc.',
    popVal: 85000000,
    suprafata: '783 562 km\u00B2',
    supVal: 783562,
    zee: '1988',
    moneda: 'Lir\u0103 Turceasc\u0103 (TRY)',
    particularitati: 'Una dintre primele \u021B\u0103ri care a recunoscut statalitatea \u00EEn 1988.',
    note: 'Turcia a recunoscut Statul Palestina \u00EEn 1988 \u0219i este unul dintre cei mai vocali sus\u021Bin\u0103tori interna\u021Bionali ai cauzei palestiniene, oferind sprijin diplomatic, economic \u0219i umanitar extins \u0219i g\u0103zduind o reprezentan\u021B\u0103 diplomatic\u0103 palestinian\u0103 major\u0103.',
    viza: {
      particular: 'Ambasada Palestinei func\u021Bioneaz\u0103 activ la Ankara, cu reprezentare extins\u0103.',
      temei: 'Afinit\u0103\u021Bi istorice otomane \u0219i solidaritate regional\u0103 puternic\u0103.',
      regim: 'Misiune diplomatic\u0103 complet\u0103 la nivel de Ambasador.',
      observatie: 'Prezint\u0103 cauza palestinian\u0103 la toate nivelurile interna\u021Bionale.'
    },
    ue: 'Stat candidat la Uniunea European\u0103.',
    schengen: 'Regim de vize obligatoriu standard.'
  },
  'south africa': {
    id: 'zaf',
    ...
    capitala: 'Pretoria',
    populatie: '\u2248 60 000 000 loc.',
    popVal: 60000000,
    suprafata: '1 221 037 km\u00B2',
    supVal: 1221037,
    zee: '1995',
    moneda: 'Rand sud-african (ZAR)',
    particularitati: 'Promotor istoric al drepturilor palestiniene Ã®n cadrul cauzelor CIJ.',
    note: 'Rela\u021Biile diplomatice depline au fost stabilite \u00EEn 1995 sub conducerea lui Nelson Mandela. Africa de Sud compar\u0103 lupta palestinian\u0103 cu mi\u0219carea anti-apartheid \u0219i a intentat cazuri r\u0103sun\u0103toare la Curtea Interna\u021Bional\u0103 de Justi\u021Bie (CIJ) privind situa\u021Bia din Gaza.',
    viza: {
      particular: 'Leg\u0103turi str\u00E2nse \u00EEntre partidul de guvern\u0103m\u00E2nt ANC \u0219i conducerea palestinian\u0103.',
      temei: 'Filozofia eliber\u0103rii na\u021Bionale \u0219i solidaritatea anti-apartheid.',
      regim: 'Ambasad\u0103 palestinian\u0103 activ\u0103 la Pretoria.',
      observatie: 'A intentat ac\u021Biunea legal\u0103 istoric\u0103 din 2023-2024 la Curtea de la Haga.'
    },
    ue: 'Partener strategic major non-european.',
    schengen: 'Regim de vize obligatoriu standard.'
  },
  'israel': {
    id: 'isr',
    ...
    capitala: 'Ierusalim (Contestat\u0103)',
    populatie: '\u2248 9 500 000 loc.',
    popVal: 9500000,
    suprafata: '20 770 km\u00B2',
    supVal: 20770,
    zee: '\u2014',
    moneda: 'Nou \u0218echel Israelian (ILS)',
    particularitati: 'Stat direct implicat \u00EEn conflictul de frontier\u0103 \u0219i suveranitate.',
    note: 'Israelul respinge ferm recunoa\u0219terea unilateral\u0103 a Statului Palestina, consider\u00E2nd-o un obstacol \u00EEn calea negocierilor directe \u0219i o recompens\u0103 pentru violen\u021B\u0103. Pozi\u021Bia oficial\u0103 a Israelului este c\u0103 statutul definitiv al teritoriilor trebuie negociat \u00EEn cadrul unui acord de pace cuprinz\u0103tor.',
    viza: {
      particular: 'Controleaz\u0103 direct securitatea frontierelor, c\u0103ile de comunica\u021Bie \u0219i spa\u021Biul aerian \u00EEn Cisiordania \u0219i Gaza.',
      temei: 'Pozi\u021Bii de securitate na\u021Bional\u0103, drepturi istorice revendicate \u0219i acordurile de la Oslo.',
      regim: 'Administrare militar\u0103 \u0219i civil\u0103 disputat\u0103 \u00EEn Teritoriile Ocupate.',
      observatie: 'Pozi\u021Bie oficial\u0103 guvernamental\u0103 de respingere a deciziilor unilaterale de recunoa\u0219tere.'
    },
    ue: 'Partener de asociere economic\u0103 \u0219i tehnologic\u0103 ultra-str\u00E2ns.',
    schengen: 'Acord de c\u0103l\u0103torie f\u0103r\u0103 vize cu spa\u021Biul Schengen.'
  }
};
...
function getFlagEmoji(engName) {
  const map = {
    ...
    'cuba': '\uD83C\uDDE8\uD83C\uDDFA', 'egypt': '\uD83C\uDDE9\uD83C\uDDFE', 'libya': '\uD83C\uDDF1\uD83C\uDDFE', 'sudan': '\uD83C\uDDF8\uD83C\uDDE9',
    'ethiopia': '\uD83C\uDDEA\uD83C\uDDF9', 'kenya': '\uD83C\uDDF0\uD83C\uDDEA', 'somalia': '\uD83C\uDDF8\uD83C\uDDF4', 'madagascar': '\uD83C\uDDF2\uD83C\uDDF6',
    'south africa': '\uD83C\uDDFF\uD83C\uDDE6', 'algeria': '\uD83C\uDDE9\uD83C\uDDFF', 'morocco': '\uD83C\uDDF2\uD83C\uDDF6', 'mauritania': '\uD83C\uDDF2\uD83C\uDDF7',
    'mali': '\uD83C\uDDF2\uD83C\uDDF1', 'niger': '\uD83C\uDDF3\uD83C\uDDEA', 'chad': '\uD83C\uDDF9\uD83C\uDDE9', 'angola': '\uD83C\uDDE6\uD83C\uDDF4',
    'namibia': '\uD83C\uDDF3\uD83C\uDDF6', 'botswana': '\uD83C\uDDE7\uD83C\uDDFC', 'zimbabwe': '\uD83C\uDDFF\uD83C\uDDFC', 'saudi arabia': '\uD83C\uDDF8\uD83C\uDDE6',
    'yemen': '\uD83C\uDDFE\uD83C\uDDEA', 'oman': '\uD83C\uDDF4\uD83C\uDDF2', 'turkey': '\uD83C\uDDF9\uD83C\uDDF7', 'syria': '\uD83C\uDDF8\uD83C\uDDFE',
    'iraq': '\uD83C\uDDEE\uD83C\uDDF6', 'iran': '\uD83C\uDDEE\uD83C\uDDF7', 'afghanistan': '\uD83C\uDDE6\uD83C\uDDFB', 'pakistan': '\uD83C\uDDF5\uD83C\uDDF0',
    'india': '\uD83C\uDDEE\uD83C\uDDF3', 'china': '\uD83C\uDDE8\uD83C\uDDF3', 'mongolia': '\uD83C\uDDF2\uD83C\uDDF3', 'russia': '\uD83C\uDDFF\uD83C\uDDFA',
    'kazakhstan': '\uD83C\uDDF0\uD83C\uDDFF', 'japan': '\uD83C\uDDEF\uD83C\uDDF5', 'south korea': '\uD83C\uDDF0\uD83C\uDDF7', 'north korea': '\uD83C\uDDF0\uD83C\uDDF5',
    'vietnam': '\uD83C\uDDFB\uD83C\uDDF3', 'laos': '\uD83C\uDDF1\uD83C\uDDE6', 'thailand': '\uD83C\uDDF9\uD83C\uDDFD', 'cambodia': '\uD83C\uDDF0\uD83C\uDDFD',
    'malaysia': '\uD83C\uDDF2\uD83C\uDDFE', 'indonesia': '\uD83C\uDDEE\uD83C\uDDF9', 'philippines': '\uD83C\uDDF5\uD83C\uDDFD', 'australia': '\uD83C\uDDE6\uD83C\uDDFA',
    'new zealand': '\uD83C\uDDF3\uD83C\uDDFF', 'greenland': '\uD83C\uDDE6\uD83C\uDDF1', 'cameroon': '\uD83C\uDDE8\uD83C\uDDF2', 'eritrea': '\uD83C\uDDEA\uD83C\uDDF7',
...
function findCountryData(d, name) {
  // 1. Cautam in baza de date Europeana detaliata
  ...
  // 2. Cautam in baza de date de Marile Puteri globale
  ...
  // 3. Generam dinamic date de baza pentru restul lumii
  ...
  return {
    ...
    categorieLabel: isNonRecognizing ? 'Nu recunoa\u0219te Palestina' : 'Recunoa\u0219te Palestina',
    lat: centroid[1] || 0,
    lon: centroid[0] || 0,
    coords: centroid || [0, 0],
    capitala: 'N/A',
...
function getTerritoryById(id) {
  ...
  // 2. Cautam in baza de date de Marile Puteri globale
  for (const name in globalMajorData) {
    const raw = globalMajorData[name];
    if (raw.inherits) continue;
    if (raw.id === id) return raw;
  }

  // 3. Cautam in restul lumii folosind topojson data
...
function renderMap() {
  ...
  if (currentMode === '2d-eur') {
    ...
    projection = d3.geoEquirectangular()
      ...
      .translate([W / 2, H / 2.1])
      .precision(0.1);
  } else if (currentMode === '2d-glob') {
    // Proiec\u021Bie geoEquirectangular planiglob global\u0103 (Planiglob)
    projection = d3.geoEquirectangular()
      .scale(W * 0.16)
      .center([0, 20])
      .translate([W / 2, H / 2.1])
    ...
    projection = d3.geoOrthographic()
      .scale(Math.min(W, H) * 0.45) // Ajustat pentru a vedea \u00EEntreaga sfer\u0103 a globului
      .translate([W / 2, H / 2])
      .clipAngle(90) // Previne randarea \u021Barilor de pe spatele globului pe fa\u021Ba acestuia!
  ...
  cachedCountries = svg.append('g')
    ...
    .attr('class', d => {
      ...
      const countryData = findCountryData(d, name);
      let cls = 'country';
      if (currentMode === '2d-eur') {
        ...
        cls += ' europe-focus'; // Make all visible globally
      }
      if (countryData) {
        cls += ' ' + countryData.categorie;
      }
      return cls;
    })
      if (t) {
    ...
    .on('click', (event, d) => {
      const name = d.properties.name ? d.properties.name.toLowerCase() : '';
      const countryData = findCountryData(d, name);
      if (countryData) selectTerritory(countryData.id);
    });
  ...
  if (currentMode.startsWith('2d')) {
    ...
    // ├Än modul 3D dezactiv─âm zoomBehavior-ul clasic ╚Öi configur─âm Dragging-ul pe Sfer─â
    svg.call(d3.drag()
      .on('start', () => {
        isRotating = false;
...
searchInput.addEventListener('input', (event) => {
  ...
  const activeList = getGlobalSearchList();
  const filtered = activeList.filter(t => 
    (t.nume && t.nume.toLowerCase().includes(query)) || 
    (t.numeEn && t.numeEn.toLowerCase().includes(query)) || 
    (t.capitala && t.capitala.toLowerCase().includes(query)) || 
    (t.categorieLabel && t.categorieLabel.toLowerCase().includes(query))
  );
...
// Comutatoare Proiec\u021Bii (2D Europa / 2D Planiglob / 3D Glob)
